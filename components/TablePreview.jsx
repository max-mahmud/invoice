      ...
      <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          ...
          <tr className="bg-white dark:bg-gray-800">
            ...
            <td className="px-6 py-4"></td>
            <td className="px-6 py-4 font-bold text-slate-800 text-base uppercase">Total Amount:</td>
            <td className="px-6 py-4 text-base uppercase font-bold text-slate-900">${totalSum.toFixed(2)}</td>
          </tr>
        </tbody>
      </table>
    </div>
