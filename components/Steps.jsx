...
const Steps = () => {
  return (
    <div className="py-12 bg-slate-100">
      <h3 className="text-4xl text-center font-medium">Create Your Invoice in Less than 2 Minutes</h3>
      <div className="flex justify-center items-center gap-4 py-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm">Your Bank Details <br /> (Optional)</p>
        </div>
        <span>
          <FaChevronRight className="text-2xl text-slate-700" />
        </span>
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm">Select Design & Colors <br /> (Download or Email Invoice)</p>
        </div>
      </div>
    </div>
  );
