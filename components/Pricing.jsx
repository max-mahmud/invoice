      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white shadow-2xl rounded-lg p-12 fle flex-col ">
            ...
            <h4 className="mb-6 text-2xl font-bold text-slate-900">Free Plan</h4>
            ...
            <Link className="font-bold text-purple-700 hover:text-purple-800" href="/invoice/new">
              Create Free Invoice
            </Link>
          </div>
          <div className="bg-white shadow-2xl rounded-lg p-12 fle flex-col ">
            ...
            <h4 className="mb-6 text-2xl font-bold text-slate-900">Premium Plan</h4>
            <p className="mb-6 text-slate-500">
              Manage your accounting at faster pace with additional premium features at minimal cost.
            </p>
            <Link className="text-purple-700 hover:text-purple-800 font-bold" href="/">
