...
export default function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6 py-2 pt-9" action="#">
      <div>
        ...
        <input
          ...
          required=""
        />
        {errors.name && <small className="text-red-600 text-sm ">This field is required</small>}
      </div>
      <div>
      ...
      <p className="text-sm font-light text-gray-500 dark:text-gray-400">
        ...
        <a href="/login" className="font-medium text-purple-600 hover:underline dark:text-purple-500">
          Login
        </a>
      </p>
    </form>
